...
public class DndTile extends QSTile<QSTile.BooleanState> {
    ...
    private static final String ACTION_SET_VISIBLE = "com.studio.shade.dndtile.SET_VISIBLE";
